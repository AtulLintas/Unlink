        ...
        <div className="sub_footer_container">
          <div className="footer_email">
            <div className="footer_email_text">
                <h2>Work with us</h2>
                <p>Let us understand your business objectives, setup initial milestones, and plan your software project</p>
            </div>
...
{/* ---------------------------------footer content---------------------------------- */}
        ...
        <div className="card footer_card">
          <div className="card-body footer_item_list" style={{width: '20rem'}}>
        ...
        <div className="card footer_card">
        ...
        </div><div className="card footer_card">
          <div className="card-body footer_item_list">
          ...
          <div className="footer_copyright">
            <div className="copyright_text">
              <h3><span>Unlink</span> Technologies</h3>
              <p>&#169; copyright 2022 | All rights reserved by unlink technologies</p> 
